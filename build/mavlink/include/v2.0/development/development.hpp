...
enum class MAV_CMD
{
    ...
    ODID_SET_EMERGENCY=12900, /* Used to manually set/unset emergency status for remote id.
    ...
    EXTERNAL_WIND_ESTIMATE=43004, /* Set an external estimate of wind direction and speed.
...
//! MAV_CMD ENUM_END
constexpr auto MAV_CMD_ENUM_END = 43005;
