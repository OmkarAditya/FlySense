...
TEST(common, KEY_COMMAND)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::common::msg::KEY_COMMAND packet_in{};
    packet_in.command = 'A';

    mavlink::common::msg::KEY_COMMAND packet1{};
    mavlink::common::msg::KEY_COMMAND packet2{};
...
#ifdef TEST_INTEROP
TEST(common_interop, KEY_COMMAND)
{
    mavlink_message_t msg;
    ...
    mavlink_key_command_t packet_c {
         'A'
    };
    ...
    mavlink_msg_key_command_encode(1, 1, &msg, &packet_c);
