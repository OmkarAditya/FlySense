...
constexpr auto MAV_PROTOCOL_CAPABILITY_ENUM_END = 262145;
...
enum class CAMERA_CAP_FLAGS : uint32_t
{
    ...
    HAS_THERMAL_RANGE=4096, /* Camera supports absolute thermal range (request CAMERA_THERMAL_RANGE with MAV_CMD_REQUEST_MESSAGE) (WIP). | */
};
...
enum class VIDEO_STREAM_STATUS_FLAGS : uint16_t
{
    ...
    THERMAL_RANGE_ENABLED=4, /* Stream can report absolute thermal range (see CAMERA_THERMAL_RANGE). (WIP). | */
};
...
#include "./mavlink_msg_key_command.hpp"
